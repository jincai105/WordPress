        ...
        <div class="nx-info-wrap-2 welcome-panel">
        	...
        	<div class="nx-info-wrap">
                ...
                <div class="nx-info-desc">
                    <p>Congratulations! You are about to use one of the most popular and intuative WordPress theme.</p>
                    <p><a class="" href="<?php echo admin_url(); ?>themes.php?page=tgmpa-install-plugins">Install Recommended Plugins</a> and <b>Kick start your website in one click</b>, Setup any one of our demo websites and edit/remove/add contents.</p>
                    <p>You can copy/edit/paste codes/sections from a demo installation to your main installation.</p>
                    <a class="button button-primary button-hero" href="https://wordpress.org/support/theme/i-max/reviews/?filter=5">Post Your Review</a>  
                    <a class="button button-primary button-hero" href="http://templatesnext.org/ispirit/landing/">Go Premium</a>   
                </div>
                <div style="display: block; clear: both; padding-top: 56px; padding-bottom: 96px;">
                    ...
                    <div style="display: block; clear: both;">
                    	...
                    	<div style="width: 20%; text-align:center; display: block; float:left; min-height: 33px;"><span class="step-or">OR</span></div>                        
                    	<div style="width: 40%; text-align:left; display: block; float:left; min-height: 33px;">
                ...
                <div class="nx-admin-row">
                	...
                	<div class="one-four-col">
                    	<a href="http://www.templatesnext.org/icreate/?page_id=541" target="_blank">
                            ...
                            <h3 class="tx-admin-link">TemplatesNext Toolkit</h3>
                        </a>
                    </div>
                	<div class="one-four-col">
                ...
                <div class="tx-wspace-24"></div>
                	...
                	<div class="nx-tab-content" style="font-size: 15px;"> 
                        ...
                        <ol>
                        	...
                        	<li>To start setting up your theme go to menu "Appearance" > "<a href="<?php echo admin_url(); ?>customize.php">Customize</a>".</li>
                        	<li>i-MAX comes with "<a href="<?php echo admin_url(); ?>themes.php?page=pt-one-click-demo-import">One Click Demo Setup</a>", You can import and setup copy of any of our demo website in one click. </li>                                  
                        </ol>
                        <span style="font-size: 13px;">Page Builder Tutorials : <a href="https://siteorigin.com/page-builder/documentation/" target="_blank">https://siteorigin.com/page-builder/documentation/</a></span>
        			</div>
                ...
                <div id="dashboard_right_now" class="postbox" style="display: block; float: right; width: 33%; max-width: 320px; margin: 16px;">
                    ...
                    <div class="inside">
                        <div class="main" style="padding: 24px;">
							<p style="padding-bottom: 12px; font-size: 15px; color: #555;">If you like a i-MAX, please share few words in your review, it helps i-MAX to spread. 
                            Few words of appriciation also motivates the designers and the developers.  </p>
                            
                            <p style="padding-bottom: 12px; font-size: 15px; color: #555;"><b>If you have not posted your review/feedback yet, we request you to post your review</b>. 
                            Even if you drop a single word, they are worth gold for us.</p>
                    		<a class="button button-primary button-hero" href="https://wordpress.org/support/theme/i-max/reviews/?filter=5">Post Your Review</a> 
