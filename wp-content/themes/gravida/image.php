                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    <header class="entry-header">
                        ...
                        <nav role="navigation" id="image-navigation" class="image-navigation">
                            ...
                            <div class="nav-next"><?php next_image_link( false, esc_attr( 'Next <span class="meta-nav">&rarr;</span>', 'gravida' ) ); ?></div>
                    ...
                    <div class="entry-content">
                        <div class="entry-attachment">
                            <div class="attachment">
                                <?php gravida_the_attached_image(); ?>
                            </div><!-- .attachment -->
                        ...
                        <?php
                            the_content();
                            wp_link_pages( array(
                                'before' => '<div class="page-links">' . esc_attr( 'Pages:', 'gravida' ),
                                'after'  => '</div>',
                            ) );
                        ?>
                    </div><!-- .entry-content -->
    
                    <?php edit_post_link( esc_attr( 'Edit', 'gravida' ), '<footer class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                </article><!-- #post-## -->
